CBOP
C     !ROUTINE: SFZ_THERMO.h
C     !INTERFACE:
C     #include "SFZ_THERMO.h"

C     !DESCRIPTION:
C     *================================================================*
C     | SFZ_THERMO.h
C     | o Header file defining "SFZ_THERMO" parameters and variables
C     *================================================================*
CEOP
...
#endif /* SFZ_THERMO_3D_STATE */
#ifdef SFZ_THERMO_2D_STATE
C     MYPA 2-dim. fields
...
#endif /* SFZ_THERMO_2D_STATE */

#ifdef SFZ_THERMO_TENDENCY
