...
C     |   The hpymm (High-Pressure icY Moon Module) package is 
...
C     sfz_rhoCoefs	:: coefficients for polynomial EoS for density 
C     sfz_etaCoefs	:: coefficients for polynomial EoS for specific entropy
...
C     sfz_pRef          :: reference pressure used in T--PT conversions [Pa]
      ...
      _RL sfz_EOSnorm_w(6)
      _RL sfz_rhoCoefs(4,4,4)
      _RL sfz_etaCoefs(4,4,4)
      _RL sfz_FPcoef_l(3)
      _RL sfz_pRef
...
C      The next two files contain data used in the EoS initialization:
C     sfz_RhoFile	      :: file containing density data
C     sfz_EtaFile	      :: file containing specific entropy data
      ...
      CHARACTER*(MAX_LEN_FNAM) sfz_RhoFile
      CHARACTER*(MAX_LEN_FNAM) sfz_EtaFile
